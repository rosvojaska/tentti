...
# Suomi-naisenhoitotyö-sanakirja:
  ...
  ### Kuukautisten kulku:
       1. Munarakkulan kypsyminen
        ...
        - Ovulaatio:
          ...
          - munarakkulan sisältä irtoaa munasolu
      2. Keltarauhasen toimintavaihe
        - puhjenneen munarakkulan tilalle nmuodostuu keltarakkula
        - keltarakkula tuottaa paljon keltarauhashormonia, eli progesteronia
        - jos munasolu ei hedelmöity, keltarauhanen surkastuu:
          - keltarauhashormoni vähenee ja kohdun limakalvo irtoaa
          - irronnut limakalvo tulee ulos kuukautisvuotona
        - jos munasolu hedelmöittyy:
          - munasolu kehittyy alkiorakkulaksi, eli blastokystiksi
          - alkiorakkula kiinnittyy kohdun limakalvoon
          - istukka tuottaa koriongonadotropiinia, josta raskaus voidaan todeta
  ### Hormonitasapaino ja siihen vaikuttavat tekijät
        - Elintapojen epätasapaino voi johtaa hormonaaliseen epätasapainoon
        - Ravinto, uni, liikunta, ilo ja ihmissuhteet oltava tasapainossa
  ### Hormonit
        - Hormonit on kemiallisia viestinviejiä
        - Hormonien eritys tapahtuu mm. kilpirauhasessa, lisämunuaisissa, aivolisäke, haima ja munasarjat
        - Hormonien epätasapaino voi aiheuttaa mm.:
  ...
  ### Keskeisiä hormoneja:
    #### Insuliini
        - säätelee sokeriaineenvaihduntaa, rasva-aineenvaihduntaa, proteiinisynteesiä
        - eritykseen vaikuttaa ruokavalio
        - liiallinen insuliini kerryttää rasvaa elimistöön
        - suuri insuliinipitoisuus lisää stressihormoni kortisolin eritystä
        - liian vähäinen insuliinieritys johtaa diabeteksen kehittymiseen
  #### Kortisoli
        - Stressi- ja energiahormoni
        - Ylläpitää verensokeria stressireaktion aikana
        - rasitus suurentaa kortisolipitoisuutta
        - Pitkäaikainen liikatuotanto varastoi rasvaa ja pienentää nais- ja mieshormonien pitoisuuksia
  #### Kilpirauhashormoni
       - säätelee aineenvaihduntaa, energiatasoja, vireystilaa, kehon lämpöä ja edistää suolen toimintaa
  #### Naishormonit ja progesteroni
      - naishormonit eli estrogeeni
      - keltarauhashormonit eli progesteroni
      - säätelee kuukautisia ja muodostaa naisellisia piirteitä
      - tasapaino pitää mielialan tasaisena, seksuaaliset halut ja suojaa hormoniperäisiltä syöviltä
      - maksan ja suoliston hyvä toiminta ylläpitää naishormoneja
  #### Mieshormonit eli androgeenit
      - vastaa energiatason ylläpidosta ja motivaatiosta
      - ylläpitää lihaskudoksen määrää ja vaikuttaa mielialaan positiivisesti
      - seksi ja painoharjoittelu lisää mieshormonin eritystä
  #### Kasvuhormonit
      - liikaa kortisolia tai insuliinia estää kasvuhormonien toimintaa
      - purkaa rasvakudosta energiaksi
  # 1.6 Seksuaali- ja lisääntymisterveys
  #### Seksuaalisuuden ja seksuaaliterveyden edistäminen hoitotyössä
      - Verrattavissa ravitsemus- ja liikuntaohjaukseen
      - Seksuaaliohjaus vastaanotolla
      - Vammaisten, ikääntyneiden jne. ohjaus ja huomiointi
      - Vuode- ja laitoshoidossa olevien erityistarpeet
  ...
  #### Gynekologiset tutkimukset vaiheet
    ...
    Varsinainen sisätutkimus
        ...
        1. Palpoidaan bimanuaalisesti kohdun koko, asento, liikkuvuus ja rakenne (toinen käsi mahan päältä ja toinen emättimen kautta)
